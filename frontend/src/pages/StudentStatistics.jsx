...
export default function StudentStatistics() {
  ...
  const handleShowStats = async () => {
    ...
    setError('');
    try {
      const url = `http://localhost:8080/api/grading_service/grades/stats/${selectedCourse}?year=${year}&exam_type=${encodeURIComponent(examType)}`;
 ...
 // const periods = selectedCourse
  //  ? (courses.find(c => c.code === selectedCourse)?.periods || ['Χειμερινό', 'Εαρινό'])
//    : [];
