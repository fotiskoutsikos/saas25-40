...
export default function InitialGrades() {
  ...
  const handleConfirm = async (e) => {
    ...
    try {
      const res = await fetch('http://localhost:8080/api/grading_service/grades/initial', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-100 px-4 py-8">
      ...
      <div className="box-default max-w-2xl mx-auto mb-6">
        <div className="box-header">
          <div className="text-primary">Upload Initial Grades</div>
        </div>
        <form onSubmit={handleConfirm}>
          ...
          <div className="flex justify-center gap-6 pt-4">
            <button type="submit" className="btn-primary text-button" disabled={loading}>
              {loading ? 'Uploading...' : 'Submit Initial Grades'}
            </button>
